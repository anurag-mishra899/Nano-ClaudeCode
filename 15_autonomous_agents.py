...
class MessageBus:
    ...
    @traceable(run_type="tool", name="MessageBus.send")
    ...
    @traceable(run_type="tool", name="MessageBus.read_inbox")
    ...
    @traceable(run_type="tool", name="MessageBus.broadcast")
...
# -- Task board scanning --
@traceable(run_type="tool", name="scan_unclaimed_tasks")
...
@traceable(run_type="tool", name="claim_task")
...
class TeammateManager:
    ...
    @traceable(run_type="tool", name="TeammateManager._set_status")
    ...
    @traceable(run_type="tool", name="TeammateManager.spawn")
    ...
    @traceable(name="TeammateManager._loop")
    ...
    @traceable(run_type="tool", name="TeammateManager._exec")
...
@traceable(run_type="tool", name="handle_shutdown_request")
...
@traceable(run_type="tool", name="handle_plan_review")
...
@traceable(run_type="tool", name="_check_shutdown_status")
