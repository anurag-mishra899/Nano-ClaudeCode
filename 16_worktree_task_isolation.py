...
class EventBus:
    ...
    @traceable(run_type="tool", name="EventBus.emit")
    def emit(
        self,
        event: str,
        task: dict | None = None,
    ...
    @traceable(run_type="tool", name="EventBus.list_recent")
...
class TaskManager:
    ...
    @traceable(run_type="tool", name="TaskManager.create")
    ...
    @traceable(run_type="tool", name="TaskManager.get")
    ...
    @traceable(run_type="tool", name="TaskManager.update")
    ...
    @traceable(run_type="tool", name="TaskManager.bind_worktree")
    ...
    @traceable(run_type="tool", name="TaskManager.unbind_worktree")
    ...
    @traceable(run_type="tool", name="TaskManager.list_all")
...
class WorktreeManager:
    ...
    @traceable(run_type="tool", name="WorktreeManager.create")
    ...
    @traceable(run_type="tool", name="WorktreeManager.list_all")
    def list_all(self) -> str:
        idx = self._load_index()
    ...
    @traceable(run_type="tool", name="WorktreeManager.status")
    ...
    @traceable(run_type="tool", name="WorktreeManager.run")
    ...
    @traceable(run_type="tool", name="WorktreeManager.remove")
    ...
    @traceable(run_type="tool", name="WorktreeManager.keep")
